	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ms-auto">
				...
				<li class="nav-item"><a class="nav-link" href="https://henakhanportfolio.netlify.app/">Contact</a></li>
			</ul>
		</div>
	</div>
</nav>
...
<div class="container mt-5">
	<div class="row">
		...
		<div class="col-md-6 mb-5">
			<div class="card bg-white"> <!-- Changed to white -->
		...
		<!-- Card 2 (Add Job) -->
		<div class="col-md-6 mb-5">
			<div class="card bg-light"> <!-- Keep this background light for contrast -->
				<div class="card-body text-center">
